...
parser.add_argument('--trained_model', default='./detection/weights/craft_mlt_25k.pth', type=str, help='pretrained model')
...
parser.add_argument('--test_folder', default='./static', type=str, help='folder path to input images')
...
result_folder = './detection/result'
...
if __name__ == '__main__':
    ...
    for k, image_path in enumerate(image_list):
        ...
        cropping.cropping(filename, file_ext)
